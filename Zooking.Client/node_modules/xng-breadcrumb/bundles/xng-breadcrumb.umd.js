(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/router'),require('@angular/common'),exports, require('@angular/core'), require('@angular/router'), require('rxjs'), require('rxjs/operators'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('xng-breadcrumb', ['@angular/core','@angular/router','@angular/common','exports', '@angular/core', '@angular/router', 'rxjs', 'rxjs/operators', '@angular/common'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.router,global.ng.common,global['xng-breadcrumb'] = {}, global.ng.core, global.ng.router, global.rxjs, global.rxjs.operators, global.ng.common));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, i0, i1, rxjs, operators, common) { 
...
var _c0 = function (a0) { return { "xng-breadcrumb-link-disabled": a0 }; };
var _c1 = function (a0, a1, a2, a3) { return { $implicit: a0, info: a1, last: a2, first: a3 }; };
function BreadcrumbComponent_ng_container_2_a_2_Template(rf, ctx) { if (rf & 1) {
    var _r12 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "a", 7);
    ɵngcc0.ɵɵlistener("click", function BreadcrumbComponent_ng_container_2_a_2_Template_a_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r12); var breadcrumb_r1 = ɵngcc0.ɵɵnextContext().$implicit; var ctx_r10 = ɵngcc0.ɵɵnextContext(); return ctx_r10.handleRoute(breadcrumb_r1); });
    ...
    var breadcrumb_r1 = ctx_r13.$implicit;
    var isLast_r2 = ctx_r13.last;
    var isFirst_r3 = ctx_r13.first;
...
function BreadcrumbComponent_ng_container_2_label_3_Template(rf, ctx) { if (rf & 1) {
    ...
    var breadcrumb_r1 = ctx_r17.$implicit;
    var isLast_r2 = ctx_r17.last;
    var isFirst_r3 = ctx_r17.first;
    ...
    ***************************************************************************** */
    ...
    var BreadcrumbService = /** @class */ (function () {
        ...
        BreadcrumbService.prototype.detectRouteChanges = function () {
            var _this = this;
            this.router.events
                .pipe(operators.filter(function (event) { return event instanceof i1.NavigationEnd; }), operators.distinctUntilChanged())
                .subscribe(function () {
...
BreadcrumbComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: BreadcrumbComponent, selectors: [["xng-breadcrumb"]], contentQueries: function BreadcrumbComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, BreadcrumbItemDirective, true, i0.TemplateRef);
    } if (rf & 2) {
        var _t;
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(BreadcrumbComponent, [{
        ...
        args: [{
            ...
            args: [BreadcrumbItemDirective, { static: false, read: i0.TemplateRef }]
        }] }); })();
...
BreadcrumbModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ factory: function BreadcrumbModule_Factory(t) { return new (t || BreadcrumbModule)(); }, imports: [[common.CommonModule, i1.RouterModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(BreadcrumbModule, { declarations: [BreadcrumbComponent, BreadcrumbItemDirective], imports: [ɵngcc2.CommonModule, ɵngcc1.RouterModule], exports: [BreadcrumbComponent, BreadcrumbItemDirective] }); })();
